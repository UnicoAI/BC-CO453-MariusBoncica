...
{
    public class GameLostScreen : IUpdateableInterface, IDrawableInterface
    {
        #region fields
        ...
        #endregion
        public GameLostScreen(App05Game game)
        {
            this.game = game;
            LoadContent();
        }
        ...
        {
            backgroundImage = game.Content.Load<Texture2D>("Backgrounds/GameLost");
